...
--SELECT EXTRACT(MONTH FROM SYSTIMESTAMP - TO_TIMESTAMP(HIRE_DATE, 'YY/MM/DD'))
--  FROM EMPLOYEES;
SELECT CEIL(MONTHS_BETWEEN(SYSDATE, HIRE_DATE)) || '개월' AS 근무개월수
    FROM EMPLOYEES;
...
SELECT FLOOR(MONTHS_BETWEEN(SYSDATE, HIRE_DATE)) AS 근무개월수,
       CASE
